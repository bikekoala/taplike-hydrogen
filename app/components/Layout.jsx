...
function DesktopHeader({isHome, menu, openCart, title}) {
  ...
  return (
    <header
      role="banner"
      className={`bg-contrast/80 text-primary hidden h-nav lg:flex items-center sticky transition duration-300 backdrop-blur-lg z-40 top-0 justify-between w-full leading-none gap-8 px-12 py-8`}
    >
